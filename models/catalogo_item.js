module.exports = (sequelize, DataTypes) => {
    ...
    const CatalogoItem = sequelize.define('CatalogoItem', {
        ...
        estado: {
            type: DataTypes.ENUM('PLANIFICACION','DISPONIBLE', 'AGOTADO','BLOQUEADO',), 
            allowNull: true, 
        ...
        //EXTERNALIZACION
        externalizacion: { type: DataTypes.BOOLEAN, defaultValue: false },

        ///////////////////////////////////////////////////////////////
        //CAMPOS COMPARTIDOS CON PRODUCTO /////////////////////////////
    ...
    CatalogoItem.associate = function(models) {
        
        //multimedia
        CatalogoItem.belongsTo(models.Multimedia,           {foreignKey: 'cat_item_image_id', as: 'imagen_principal'});  
        CatalogoItem.hasMany(models.Multimedia,             {foreignKey: 'cat_item_images_id', as: 'imagenes'}); 

        //Empresa
        CatalogoItem.belongsTo(models.Empresa, {foreignKey: 'empresa_id', as: 'empresa'});
